...
var products = {
    obatbatuk: {
        siladex: new Products("Obatbatuk", "Siladex", 15000, "Yes"),
        woods: new Products("Obatbatuk", "Woods", 8000, "Yes"),
        vicks: new Products("Obatbatuk", "Vicks", 19000, "Yes"),
    },
    obatflu: {
        panadol: new Products("Obatflu", "Panadol", 21000, "Yes"),
        bodrex: new Products("Obatflu", "Bodrex Flu", 10000, "No"),
        Bisolvon: new Products("Obatflu", "Bisolvon", 6500, "Yes"),
    },
    obatgatal: {
        ketoconazole: new Products("Obatgatal", "Ketoconazole", 14000, "Yes",),
        caladine: new Products("Obatgatal", "Caladine", 7500, "No"),
        griseofulvin: new Products("Obatgatal", "Griseofulvin", 21800, "Yes"),
    },
}
function filter() {
            ...
            if (name === key2) {
                swal({
                    ...
                    text: "Category : " + "( " + products[key][key2].category + " )  "
                        ...
                        + " --- Price : ( Rp " + products[key][key2].price + " ) ",
                    textColor: "red",
                    imageUrl: src,
                    imageWidth: 300,
                    imageHeight: 250,
                ...
                for (var key2 in products[key]) {
                    if (nameProduct === key2) {
                        ...
                        swal({
                            type: "success",
                            title: "SOLD!",
                            text: "Product " + products[key][key2].name + " has been Sold. Total Price : " + quantity + "X" + products[key][key2].price + "= Rp " + quantity * products[key][key2].price + "." + "THANKS!",
                        })
                        var soldd = {
                            date: DATE,
                            name: NAME,
...
function insertData(id) {
    ...
    if (id === "obatbatuk") {
        ...
        counterForFoot++;
        var maintarget = document.getElementById("newAddedOfObatbatuk");
        ...
        var a = document.getElementById("obatbatukAdd");
    ...
    if (id === "obatflu") {
        ...
        counterForFoot++;
        var maintarget = document.getElementById("newAddedOfObatflu");
        ...
        mainDiv.appendChild(deleteBtn);
        maintarget.appendChild(mainDiv);
        var a = document.getElementById("obatfluAdd");
        a.removeAttribute("onclick");
        a.style.backgroundColor = "rgb(164, 252, 164)"
    }
    if (id === "obatgatal") {
        ...
        counterForFoot++;
        var maintarget = document.getElementById("newAddedOfObatgatal");
        ...
        maintarget.appendChild(mainDiv);
        var a = document.getElementById("obatgatalAdd");
        a.removeAttribute("onclick");
        a.style.backgroundColor = "rgb(164, 252, 164)"
    }
}
